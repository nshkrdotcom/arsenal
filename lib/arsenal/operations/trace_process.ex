defmodule Arsenal.Operations.TraceProcess do
  @moduledoc """
  ...
  defp store_trace_info(trace_id, info) do
    ...
    case Arsenal.Operations.Storage.TraceSessionStorage.store_session(trace_id, info) do
      :ok ->
        :ok
  ...
  defp stop_trace(pid, trace_id) do
    ...
    # Stop collector
    case Arsenal.Operations.Storage.TraceSessionStorage.get_session(trace_id) do
      {:ok, %{collector: collector_pid}} ->
        GenServer.stop(collector_pid)
        Arsenal.Operations.Storage.TraceSessionStorage.delete_session(trace_id)
...
defmodule Arsenal.Operations.TraceProcess.TraceCollector do
  @moduledoc """
